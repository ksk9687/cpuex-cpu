...
cpuv4 : tmp/4/alu.cmp tmp/4/sramc.cmp tmp/4/cache.cmp tmp/4/reservationStation.cmp\
	tmp/4/reg.cmp tmp/4/memory.cmp tmp/4/iou.cmp tmp/4/rs232c.cmp tmp/4/led.cmp\
